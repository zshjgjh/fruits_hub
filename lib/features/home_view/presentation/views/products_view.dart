          ...
          child: CustomScrollView(
            ...
            SliverToBoxAdapter(
              child: Column(
                ...
                children: [
                  buildAppBar(context, title: 'Products', leading: Image.asset(Assets.imagesNotification)),
                  SearchField(),
                  Row(
                    children: [
            ...
            SliverToBoxAdapter(
              child: Row(
                children: [
                  ...
                  Spacer(),
                  GestureDetector(
                      child: Text('Show more',style: Styles.regular13.copyWith(color: Color(0xFF949D9E)),))
                ],
              ),
            ),
                SliverToBoxAdapter(
