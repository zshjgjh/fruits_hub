...
import 'package:fruits_hub/features/login_view/presentation/views/widgets/loginn_view_body.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocProvider<SigninCubit>(
        create: (context) => SigninCubit(authRepo:AuthRepoImpl(fireBaseAuthService: FireBaseAuthService())),
        child: LoginViewBody(),
      ),
    );
  }
